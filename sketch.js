...
//find the bug in the below code
	dustbinImg = createImage("dustbin.png");
	paperImg = createImage("paper.png");
...
image(image(dustbinImg),ball.position.x,ball.position.y,radius,radius);

	// use image() command to add dustbin image in the canvas.
	image(image(paperImg),1185, 570, 200,200);
